...
"""
	...
	def simulation(self):
		...
		self.selectedtxt_lbl = WrappingLabel(self.selectedtxt_frame, text="Voici les images que vous avez selectionnées précédemment",font=self.font,bg='#CAD5CA')
